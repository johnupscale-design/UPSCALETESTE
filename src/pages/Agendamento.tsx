    ...
    <div className="bg-gray-50 text-gray-800 flex items-center justify-center pt-12 pb-3 px-3 mt-0" style={{ fontFamily: 'Inter, sans-serif' }}>
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg text-center overflow-hidden">
        <div className="p-6 sm:p-8">
          ...
          <div className="text-left bg-gray-50 rounded-lg p-5 mb-8 border border-gray-200">
        ...
        <a href="#" className="w-full block bg-[#252525] text-white text-base py-5 px-8 transition-colors hover:bg-[#3a3a3a] focus:outline-none focus:ring-4 focus:ring-gray-400">
