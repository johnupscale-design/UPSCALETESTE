...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen pt-20 bg-gradient-to-br from-primary/5 via-background to-accent/5">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 py-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
              ...
              Mais de 130.000 empresas parceiras
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              Upscale é a plataforma completa para agendamento inteligente, gestão de clientes e marketing, 
