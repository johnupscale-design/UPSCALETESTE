  ...
  <section className="py-20 bg-gradient-to-br from-primary to-accent text-primary-foreground">
    <div className="container mx-auto px-4 max-w-2xl">
      <div className="flex flex-col gap-8 mb-12">
        {/* Card 1: Fale conosco */}
        <div className="rounded-3xl p-7 flex flex-col gap-4" style={{ background: '#252525' }}>
        ...
        {/* Card 2: Veja a Demo */}
        <div className="rounded-3xl p-7 flex flex-col gap-4 bg-white">
          ...
          <button className="bg-[#F3F3F3] text-[#252525] font-semibold rounded-full px-6 py-2 w-fit self-start hover:bg-gray-200 transition">Ver agora</button>
        </div>
      </div>
      {/* Card 3: Copy principal em container com gradiente azul */}
      <div className="rounded-3xl p-7 flex flex-col gap-4 mb-8 bg-gradient-to-br from-primary to-accent text-primary-foreground items-start">
